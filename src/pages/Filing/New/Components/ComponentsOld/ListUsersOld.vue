...
definePage({
  path: "Filing/New/ListUsersOld/:id/:invoice_id",
  name: "Filing-New-ListUsersOld",
  meta: {
...
const inputsTableFilter = ref([
  ...
  { key: "Tipo_de_identificacion_del_usuario", title: "Tipo de identificación del usuario.", sortable: true, width: "10" },
  { key: "numDocumentoIdentificacion", title: "Número de identificación del usuario del sistema", sortable: true, width: "350" },
  { key: "Codigo_entidad_administradora", title: "Código entidad administradora", sortable: true, width: "200" },
  { key: "Tipo_de_usuario", title: "Tipo de usuario", sortable: true, width: "350" },
  { key: "Primer_apellido_del_usuario", title: "Primer apellido del usuario", sortable: true, width: "200" },
  { key: "Segundo_apellido_del_usuario", title: "Segundo apellido del usuario", sortable: true, width: "200" },
  { key: "Primer_nombre_del_usuario", title: "Primer nombre del usuario", sortable: true, width: "350" },
  { key: "Segundo_nombre_del_usuario", title: "Segundo nombre del usuario", sortable: true, width: "350" },
  { key: "Edad", title: "Edad", sortable: true, width: "350" },
  { key: "Unidad_de_medida_de_la_edad", title: "Unidad de medida de la edad", sortable: true, width: "200" },
  { key: "Sexo", title: "Sexo", sortable: true, width: "350" },
  { key: "Codigo_del_departamento_de_residencia_habitual", title: "Código del departamento de residencia habitual", sortable: true, width: "350" },
  { key: "Codigo_del_municipio_de_residencia_habitual", title: "Código del municipio de residencia habitual", sortable: true, width: "350" },
  { key: "Zona_de_residencia_habitual", title: "Zona de residencia habitual", sortable: true, width: "350" },
]);
