...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'rips-automatic-components-modal-upload-file-zip': RouteRecordInfo<'rips-automatic-components-modal-upload-file-zip', '/Rips/Automatic/Components/ModalUploadFileZip', Record<never, never>, Record<never, never>>,
    'Rips-Automatic-List': RouteRecordInfo<'Rips-Automatic-List', '/Rips/Automatic/List', Record<never, never>, Record<never, never>>,
    'Rips-Manual-List': RouteRecordInfo<'Rips-Manual-List', '/Rips/Manual/List', Record<never, never>, Record<never, never>>,
